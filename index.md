...
![](pictures/72143301_1568825296592681_5980310628999364608_n%20copy.jpg)
...
However, I haven't had the opportunity to interact with Git during my internship, so I had just recently learned about commands such as:
```
git branch
git commit
git push
...
Here is my [LinkedIn](https://www.linkedin.com/in/simonjliu/)


### Hobbies and Interests

Outside of work, I like to stay active. I spend my free time
...
Additionally, I like to watch the NBA, and my top three favorite teams currently are

1. LA Clippers
2. New York Knicks
3. Miami Heat

I also like to research about ways to make money, and have found many side hustles. Here is my list with the ones x'd out as having already started:
